...
module spo2_calculator (
    ...
    // Module-level register declarations for SpO2 calculation
    // Moved out of procedural blocks to comply with strict Verilog-2001 syntax
    reg [15:0] r_scaled;
    reg [23:0] spo2_temp;
        ...
        if (!rst_n) begin
            ...
            case (state)
                ...
                S_CALC_SPO2: begin
                    ...
                    spo2_temp <= 110 - ((25 * ((quotient > 48'hFFFF) ? 16'hFFFF : quotient[15:0])) >> 10);

                    // Clamp final SpO2 to standard physiological bounds [50, 100]
                    if (110 - ((25 * ((quotient > 48'hFFFF) ? 16'hFFFF : quotient[15:0])) >> 10) > 100) begin
                        spo2_out <= 8'd100;
                    end else if (110 - ((25 * ((quotient > 48'hFFFF) ? 16'hFFFF : quotient[15:0])) >> 10) < 50) begin
                        spo2_out <= 8'd50;
                    end else begin
                        spo2_out <= 110 - ((25 * ((quotient > 48'hFFFF) ? 16'hFFFF : quotient[15:0])) >> 10);
                    end
