...
Default Utilization Sweep: 30%, 32%, 34%, 36%, 38% (2% interval)
...
def main():
    ...
    parser.add_argument("--utils", default="30,32,34,36,38", help="Comma-separated utilization percentages")
